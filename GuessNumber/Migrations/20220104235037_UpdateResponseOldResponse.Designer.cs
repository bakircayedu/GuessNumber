...
namespace GuessNumber.Migrations
{
    ...
    [Migration("20220104235037_UpdateResponseOldResponse")]
    partial class UpdateResponseOldResponse
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuessNumber.Areas.Identity.Data.GuessNumberUser", b =>
                {
            ...
            modelBuilder.Entity("GuessNumber.Models.GamePlayMove", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GuessNumber.Models.MatchRequest", b =>
                {
                    ...
                    b.Property<int?>("IsPlayerRequestHandled")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GuessNumber.Models.GameResult", b =>
                {
                    b.HasOne("GuessNumber.Areas.Identity.Data.GuessNumberUser", "Player")
                        .WithMany()
                        .HasForeignKey("GuessNumberUserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GuessNumber.Areas.Identity.Data.GuessNumberUser", null)
                        .WithMany()
